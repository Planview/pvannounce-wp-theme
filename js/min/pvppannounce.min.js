...
var current_item=0;window.sectionShowing=null,jQuery(document).ready(function(i){i(document).on("gform_post_render",function(){i(".gfield").each(function(){i(this).find("input, textarea, select").not('input[type="checkbox"], input[type="radio"]').addClass("form-control")}),i(".gfield_checkbox, .gfield_radio").find('input[type="checkbox"], input[type="radio"]').each(function(){var t=i(this).siblings("label");i(this).prependTo(t)}).end().each(function(){i(this).after('<span class="help-block"></span>'),i(this).is(".gfield_checkbox")?i(this).addClass("checkbox"):i(this).addClass("radio")})});var t=1300,n=1300,o=function(o,a,e){var s=i(o);window.sectionShowing?i(".section:visible").fadeOut(t,function(){s.fadeIn(n),e?i.noop():History.pushState(null,null,o),window.sectionShowing=o,(a||i.noop)()}):(i(".section:visible").hide(),s.show(function(){e?i.noop():History.pushState(null,null,o),window.sectionShowing=o,(a||i.noop)()})),i("a",".mainmenu").removeClass("active"),i('a[href="'+o+'"]',".mainmenu").addClass("active")};i(".section-link a, a.section-link").on("click",function(t){if(!i(this).hasClass("active")){t.preventDefault();var n=i(this).attr("href");o(n)}}),i(".modal-link a, a.modal-link").on("click",function(t){t.preventDefault();var n=i(this).attr("href");i(n).modal("show")});var a=i(window.location.hash);if(window.location.hash&&a.hasClass("section"))o(window.location.hash);else{var e=i.noop;a.hasClass("modal")&&(e=function(){a.modal("show")});var s="#"+i(".section").first().attr("id");o(s,e)}i(document).on("hide.bs.modal",function(){History.replaceState(null,null,"#"+i(".section:visible").attr("id"))}),i(window).on("hashchange",function(){var t=i(window.location.hash);t.hasClass("section")?o(window.location.hash,i.noop,!0):t.hasClass("modal")&&t.modal("show")})}),jQuery(document).ready(function(i){i(window).on("resize",function(){i(".limelight-video-respond").each(function(){var t,n,o=i(this),a=i(this).find("*[width]"),e=i(this).data("controlsHeight")||0,s=i(this).data("controlsWidth")||0;if(!o.data("aspectRatio")){var c=(a.attr("height")-e)/(a.attr("width")-s);o.data("aspectRatio",c)}n=o.width(),t=(n-s)*o.data("aspectRatio")+e,a.attr("height",t),a.attr("width",n)})}),i(window).trigger("resize")});